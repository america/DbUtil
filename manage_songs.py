...
class manage_songs():
    ...
    def show_all_msgs(self):
        sql_file = "sql/select_msg_from_songs.sql"
...
if __name__ == '__main__':
    ...
    def usage():
        ...
        print("                      2 [free word]            ... dump all message list to " + script_name + "_list.log")
        sys.exit()
